...
import alg.AlgInfo;
import algs.cvrg.CoordinationServer;
import algs.cvrg.Party1;
import algs.cvrg.Party2;
 ...
 * This experiment uses CVRG method proposed by Dai et al.[1].
 * [1] Dai M, Zheng Z, Hong Z, et al. Edge Computing Aided Coded Vertical Federated Linear Regression[J]. IEEE Transactions on Cognitive Communications and Networking, 2022.
 */
public class ExpForCVRG {
	public static Map<String, Object> run(String paramJson) {
		...
		double learningRate = ((Number) ((Map) param.get("data")).get("learningRate")).doubleValue();
		double initBias = ((Number) ((Map) param.get("data")).get("initBias")).doubleValue();
